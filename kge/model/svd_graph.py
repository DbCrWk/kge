...
class SvdGraphScorer(RelationalScorer):
    r"""Implementation of the SVD Graph KGE scorer."""
...
class SvdGraph(KgeModel):
    r"""Implementation of the proposed SVD Graph KGE model."""
    ...
    def __init__(self, config: Config, dataset: Dataset, configuration_key=None):
        ...
        super().__init__(
            config, dataset, SvdGraphScorer, configuration_key=self.configuration_key
        )
